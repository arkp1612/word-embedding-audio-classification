...
if __name__== "__main__":
    ...
    test_ds = generate_datasets_from_dir('/srv/data/mtt/tfrecords/log-mel-complete','log-mel-spectrogram')
    ...
    with open(os.path.join(directory,'stage_3_model_log-mel_per_cat_test_mtt.txt'), 'w') as f:
