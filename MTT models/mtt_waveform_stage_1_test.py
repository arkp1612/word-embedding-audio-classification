...
def _generate_datasets(tfrecords, audio_format, split=None, which_split=None, sample_rate=16000, num_mels=96, batch_size=32, block_length=1, cycle_length=1, shuffle=True, shuffle_buffer_size=10000, window_length=15, window_random=False,top=25,as_tuple=True,repeat=1):
...
if __name__== "__main__":
    ...
    test_ds = generate_datasets_from_dir('/srv/data/mtt/tfrecords/waveform-complete','waveform')
    
    log_dir = os.getcwd()
    log_dir = os.path.join(os.path.expanduser(log_dir), 'waveform_stage_1_mtt',)
    ...
    with open(os.path.join(directory,'mtt_stage_1_model_waveform_per_cat_test.txt'), 'w') as f:
