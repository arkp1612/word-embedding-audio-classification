...
def build_model(frontend_mode, num_output_neurons=25, y_input=96, num_units=500, num_filts=16, batch_size=16):
...
if __name__== "__main__":
    train_ds,valid_ds,test_ds = generate_datasets_from_dir('/srv/data/mtt/tfrecords/waveform-complete','waveform')
    print("Datasets created")
    log_dir = os.getcwd()
    log_dir = os.path.join(os.path.expanduser(log_dir), 'mtt_waveform_stage_3')
    ...
    with open(os.path.join(directory,'mtt_stage_3_model_waveform_test.txt'), 'w') as f:
