...
if __name__== "__main__":
    ...
    train_ds,valid_ds,test_ds = generate_datasets_from_dir('/srv/data/msd/tfrecords/log-mel-complete','log-mel-spectrogram')
    log_dir = os.getcwd()
    ...
    with open(os.path.join(directory,'stage_1_model_log-mel_test.txt'), 'w') as f:
