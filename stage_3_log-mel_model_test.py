...
if __name__== "__main__":
    ...
    _,_,test_ds = generate_datasets_from_dir('/srv/data/tfrecords/log-mel-complete','log-mel-spectrogram')
    ...
    with open(os.path.join(directory,'stage_3_model_log-mel_per_cat_test.txt'), 'w') as f:
